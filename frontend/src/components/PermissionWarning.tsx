  ...
  return (
    <div className="max-w-md mb-4 space-y-3">
      ...
      {(!hasMicrophone || !hasSystemAudio) && (
        <Alert variant="destructive" className="border-impulso-ocean/40 bg-impulso-ocean/10">
          <AlertTriangle className="h-5 w-5 text-impulso-ocean" />
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {isMacOS && !hasMicrophone && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-impulso-ocean hover:bg-impulso-ocean/90 rounded-md transition-colors"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-impulso-ocean bg-impulso-ocean/10 hover:bg-impulso-ocean/20 rounded-md transition-colors disabled:opacity-50"
            >
              <RefreshCw className={`h-4 w-4 ${isRechecking ? 'animate-spin' : ''}`} />
              Recheck
            </button>
          </div>
          <AlertDescription className="text-impulso-ocean mt-2">
            {/* Microphone Warning */}
            {!hasMicrophone && (
              <>
                <p className="mb-3">
                  MinutIA needs access to your microphone to record meetings. No microphone devices were detected.
                </p>
                ...
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    ...
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      ...
                      <li>Grant Screen Recording permission to MinutIA</li>
