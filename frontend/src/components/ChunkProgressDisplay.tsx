...
export function ChunkProgressDisplay({
  ...
  const getChunkStatusColor = (status: ChunkStatus['status']) => {
    switch (status) {
      case 'completed':
        return 'text-impulso-ocean bg-impulso-ocean/10 border-impulso-ocean/30';
      case 'processing':
    ...
    <div className={`bg-card border border-border rounded-lg p-4 ${className}`}>
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-3">
          ...
          {isPaused && (
            <span className="bg-impulso-ocean/10 text-impulso-ocean px-2 py-1 rounded-full text-xs font-medium">
              Paused
            </span>
          )}
        </div>
        ...
        <div className="flex items-center space-x-2">
          {!isPaused ? (
            <button
              onClick={onPause}
              className="bg-impulso-ocean hover:bg-impulso-ocean/90 text-white px-3 py-1 rounded text-sm transition-colors"
      ...
      <div className="grid grid-cols-4 gap-4 mb-4 text-sm">
        <div className="text-center">
          <div className="text-lg font-semibold text-impulso-ocean">
      ...
      {progress.completed_chunks === progress.total_chunks && progress.total_chunks > 0 && (
        <div className="mt-4 bg-impulso-ocean/10 border border-impulso-ocean/30 rounded-lg p-3">
          <div className="flex items-center space-x-2">
            <span className="text-impulso-ocean">🎉</span>
            <span className="text-sm font-medium text-impulso-ocean">
