        ...
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-impulso-ocean text-primary-foreground rounded-lg hover:bg-impulso-ocean/90 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              {isImporting ? (
                <>
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-primary/40 text-primary rounded-lg hover:bg-primary/10 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
