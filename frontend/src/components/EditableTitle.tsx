  ...
  return isEditing ? (
    <div className="flex-1">
      <textarea
        ...
        className="text-2xl font-bold bg-muted/40 border border-border focus:outline-none focus:ring-2 focus:ring-primary rounded px-3 py-1 w-full resize-none overflow-hidden"
