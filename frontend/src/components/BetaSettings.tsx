...
export function BetaSettings() {
  ...
  return (
    <div className="space-y-6">
      {/* Warning Banner */}
      <div className="flex items-start gap-3 p-4 bg-impulso-ocean/10 border border-impulso-ocean/30 rounded-lg">
        <AlertCircle className="h-5 w-5 text-impulso-ocean flex-shrink-0 mt-0.5" />
          ...
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="px-2 py-0.5 text-xs font-medium bg-impulso-ocean/10 text-impulso-ocean rounded-full">
                  BETA
                </span>
              </div>
