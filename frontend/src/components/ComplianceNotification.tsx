      ...
      <div className="bg-card border border-border rounded-lg shadow-lg p-3">
        ...
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-1">
            <AlertTriangle className="h-3 w-3 text-impulso-ocean flex-shrink-0" />
        ...
        <div className="mb-2">
          ...
          <div className="bg-impulso-ocean/10 border border-impulso-ocean/30 rounded p-1">
            <p className="text-xs text-impulso-ocean font-medium">
        ...
        <div className="flex gap-1">
          ...
          <Button
            ...
            className="text-xs px-2 py-0.5 h-6 bg-impulso-ocean hover:bg-impulso-ocean/90 flex-1"
          >
