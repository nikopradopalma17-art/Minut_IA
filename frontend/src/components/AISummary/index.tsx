  ...
  return (
    <div className="relative">
      ...
      {contextMenu.visible && selectedBlocks.length > 0 && (
        ...
        >
          <button
            className="w-full px-4 py-2 text-left hover:bg-muted/40 flex items-center space-x-2"
          ...
          <button
            className="w-full px-4 py-2 text-left hover:bg-muted/40 text-destructive flex items-center space-x-2"
