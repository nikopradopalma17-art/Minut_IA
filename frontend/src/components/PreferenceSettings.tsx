...
export function PreferenceSettings() {
  ...
  if (isLoadingPreferences && !notificationSettings && !storageLocations) {
    return <div className="max-w-2xl mx-auto p-6">{t("settings.loading")}</div>
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-foreground mb-2">{t("settings.notifications_title")}</h3>
      ...
      <div className="bg-card rounded-lg border border-border p-6 shadow-sm">
        <h3 className="text-lg font-semibold text-foreground mb-4">{t("settings.storage_title")}</h3>
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 border rounded-lg bg-muted/40">
            <div className="font-medium mb-2 text-foreground">{t("settings.recordings_title")}</div>
        ...
        <div className="mt-4 p-3 bg-impulso-ocean/5 rounded-md">
          <p className="text-xs text-impulso-ocean">
            <strong>{t("settings.note_title")}</strong> {t("settings.note_body")}
          </p>
        </div>
      </div>
