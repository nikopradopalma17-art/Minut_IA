...
export default function AnalyticsConsentSwitch() {
  ...
  const handlePrivacyPolicyClick = async () => {
    try {
      await invoke('open_external_url', { url: 'https://github.com/nikopradopalma17-art/Minut_IA/blob/main/PRIVACY_POLICY.md' });
    } catch (error) {
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    {isCopied ? (
                      <>
                        <Check className="w-3.5 h-3.5 text-impulso-ocean" />
                        <span className="text-impulso-ocean">Copied!</span>
                      </>
                    ) : (
                      <>
