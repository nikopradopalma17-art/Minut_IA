...
export default function AnalyticsDataModal({ isOpen, onClose, onConfirmDisable }: AnalyticsDataModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-impulso-obsidian/70 flex items-center justify-center z-50">
      <div className="bg-card rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 space-y-6">
          {/* Privacy Notice */}
          <div className="bg-impulso-ocean/10 border border-impulso-ocean/30 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <Info className="w-5 h-5 text-impulso-ocean mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-impulso-baltic/10 border border-impulso-baltic/30 rounded-lg p-4">
            <h4 className="font-semibold text-impulso-baltic mb-2">What We DON'T Collect:</h4>
            <ul className="text-sm text-impulso-baltic space-y-1 ml-4">
